...
// desta lista.
const ADMIN_ONLY_SETTINGS_GROUP_IDS = ['sysGroupDatabase', 'sysGroupSslCertificate', 'sysGroupApiAccess', 'sysGroupOAuth', 'sysGroupLogo', 'registerNavBtn', 'importAsSystemRow'];
